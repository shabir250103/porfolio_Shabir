document.addEventListener('DOMContentLoaded', () => {
    ...
    // 8. Canvas Particle Engine (UI UX Pro Max Constellation)
    const canvas = document.getElementById('bg-canvas');
    if (canvas) {
        const ctx = canvas.getContext('2d');
        let particlesArray = [];
        const numberOfParticles = window.innerWidth < 768 ? 40 : 100; // Optimize for mobile
        ...
        // Remove mouse interaction on leave
